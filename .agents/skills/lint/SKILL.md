...
4. **Impute Data (Tool Wrapper / Generator):** For identified knowledge gaps or explicit "TODO" markers, execute a web search. Synthesize the search results to generate the missing content.
5. **Generate Proposals (Generator):** Analyze isolated or loosely connected documents. Generate a list of proposed new Concept Pages that combine overlapping themes.
